...
<div class="container-fluid">
    ...
    <div class="page-header mb-4">
        <div>
            ...
            <p class="page-subtitle">Dafrarkan akun operator admin baru atau entitas data customer secara manual ke dalam sistem.</p>
        </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group-custom @error('name') input-error @enderror">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="custom-form-control" placeholder="Masukkan nama lengkap user..." required>
                </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group-custom @error('email') input-error @enderror">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" class="custom-form-control" placeholder="contoh@email.com" required>
                </div>
                @error('email') <span class="form-error-msg"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</span> @enderror
            </div>

            <div class="form-group mb-4">
                <label class="custom-form-label">Sandi Masuk (Password)</label>
                <div class="input-group-custom @error('password') input-error @enderror">
                    <i class="fa-solid fa-lock input-icon"></i>
                    <input type="password" name="password" class="custom-form-control" placeholder="Minimal 6 karakter..." required>
                </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group-custom">
                    ...
                    <select name="role" class="custom-form-control-select">
                        <option value="user" {{ old('role') == 'user' ? 'selected' : '' }}>User Biasa (Customer)</option>
            ...
            <div class="form-group mb-5">
                <label class="custom-form-label">Status Awal Akun</label>
                <div class="input-group-custom">
                    <i class="fa-solid fa-toggle-on input-icon"></i>
                    <select name="is_active" class="custom-form-control-select">
                        <option value="1" {{ old('is_active', '1') == '1' ? 'selected' : '' }}>Aktif (Diberikan Akses)</option>
                        <option value="0" {{ old('is_active') == '0' ? 'selected' : '' }}>Nonaktif (Blokir / Suspensi)</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-actions flex-wrap gap-2">
                ...
                <button type="submit" class="btn-submit">
                    <i class="fa-solid fa-user-plus me-1.5"></i> Daftarkan User Baru
                </button>
            </div>
        </form>
    </div>
