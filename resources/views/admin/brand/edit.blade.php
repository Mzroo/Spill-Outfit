...
<div class="container-fluid">
    ...
    <div class="page-header mb-4">
        <div>
            ...
            <p class="page-subtitle">Perbarui informasi profil, berkas logo resmi, atau status publikasi dari merek terkait.</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.brand.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-7">
                    ...
                    <!-- UPLOAD LOGO BRAND (DROPZONE BOX STYLE) -->
                    <div class="form-group-custom mt-4">
                        ...
                        <div class="custom-file-upload">
                            ...
                            <label for="logoInput" class="file-upload-label">
                                ...
                                <span>Pilih file logo baru jika ingin mengganti</span>
                    ...
                    <!-- STATUS KEMITRAAN BRAND (RADIO CARDS) -->
                    <div class="form-group-custom mt-4">
                        <label class="form-label-custom">
                        ...
                        <div class="status-radio-container">
                            <label class="radio-card">
                                <input type="radio" name="status" value="aktif" {{ old('status', $brand->status) == 'aktif' ? 'checked' : '' }}>
                            ...
                            <label class="radio-card">
                                <input type="radio" name="status" value="nonaktif" {{ old('status', $brand->status) == 'nonaktif' ? 'checked' : '' }}>
                                <div class="radio-content">
                    ...
                    <div class="d-flex align-items-center gap-3 mt-5 action-container">
                        <button type="submit" class="btn-save">
                            <i class="fa-solid fa-pen-to-square me-2"></i>Perbarui Data Brand
                        </button>
                        ...
                        <div class="preview-card">
                            ...
                            <div class="preview-logo-wrapper">
                                <div class="preview-image-box">
                                    <img
                                        id="previewLogo"
                                        src="{{ $brand->logo ? asset('storage/' . $brand->logo) : 'https://placehold.co/300x300/faf6ef/B68D40?text=LOGO+BRAND' }}"
                            ...
                            <div class="preview-details text-center mt-3">
                                <h2 id="previewNama" class="preview-name text-truncate">{{ $brand->nama }}</h2>
                                <div class="mb-2">
                                    <span id="previewSlug" class="preview-slug-badge">
                                        <i class="fa-solid fa-link me-1" style="font-size: 10px;"></i>{{ $brand->slug }}
                                    </span>
                                </div>
                                
                                <span id="previewStatusBadge" class="status-badge {{ $brand->status == 'aktif' ? 'status-active' : 'status-inactive' }} mt-1">
                                ...
                                <div class="text-start">
                                    ...
                                    <p id="previewDeskripsi" class="preview-desc-text text-muted">
                                        {{ $brand->deskripsi ?? 'Belum ada deskripsi profil brand fashion yang dituliskan saat ini...' }}
                                    </p>
                                </div>
                            </div>
                        </div>
